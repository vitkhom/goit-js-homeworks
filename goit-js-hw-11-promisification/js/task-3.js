...
/*
 * Должно работать так (переписал с промисами, деструктуризировал transaction 
  и передал через resolve два параметра в виде обьектаб что потянуло за собою другие изменения)
 */
